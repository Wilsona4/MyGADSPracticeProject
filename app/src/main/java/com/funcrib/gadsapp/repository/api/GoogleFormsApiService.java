...
public class GoogleFormsApiService {
    ...
    public static void submitProject(SubmissionModel submissionModel, @NonNull final ApiResponseCallback<Void> callback) {
        retrofitInterface.submitProject(submissionModel.getFirstName(), submissionModel.getLastName(), submissionModel.getEmail(), submissionModel.getProjectUrl())
